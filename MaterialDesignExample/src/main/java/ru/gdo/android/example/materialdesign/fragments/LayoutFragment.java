...
import ru.gdo.android.library.materialdesign.widget.SlidingToggleSwitchView;
...
public class LayoutFragment extends BaseFragment implements OnToggleListener {

    private TextView tvSelected;
    private CompoundButton.OnCheckedChangeListener checkListener;
    private CheckBox cbChecked;
    private SlidingToggleSwitchView sw;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sw = (SlidingToggleSwitchView) rootView.findViewById(R.id.sliding_toggle_switch);
        ...
        cbEnabled.setEnabled(sw.isEnabled());
        ...
        tvSelected.setText(sw.getText(SlidingToggleSwitchView.SWITCH_ON));
    ...
    public void onToggle(int result) {
        ...
        try {
            ...
            cbChecked.setChecked(result == SlidingToggleSwitchView.SWITCH_ON);
        } finally {
            cbChecked.setOnCheckedChangeListener(checkListener);
        }
