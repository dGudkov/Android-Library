...
public class MDCheckBox extends View {
    ...
    private void init(AttributeSet attrs){
        if (attrs != null){
            TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.MDCheckBox);
            mStrokeWidth = (int)array.getDimension(R.styleable.MDCheckBox_cb_stroke_width, dip(mStrokeWidth));
            mStrokeColor = array.getColor(R.styleable.MDCheckBox_cb_stroke_color, mStrokeColor);
            mCircleColor = array.getColor(R.styleable.MDCheckBox_cb_circle_color, mCircleColor);
            array.recycle();
        }else {
