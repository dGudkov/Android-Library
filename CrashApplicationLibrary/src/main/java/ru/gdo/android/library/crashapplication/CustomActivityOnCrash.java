package ru.gdo.android.library.crashapplication;
...
import ru.gdo.android.library.crashapplication.R;
import ru.gdo.android.library.crashapplication.activity.DefaultErrorActivity;
...
public class CustomActivityOnCrash {
    ...
    private static final String EXTRA_RESTART_ACTIVITY_CLASS = "ru.gdo.android.library.crashapplication.EXTRA_RESTART_ACTIVITY_CLASS";
    private static final String EXTRA_SHOW_ERROR_DETAILS = "ru.gdo.android.library.crashapplication.EXTRA_SHOW_ERROR_DETAILS";
    private static final String EXTRA_STACK_TRACE = "ru.gdo.android.library.crashapplication.EXTRA_STACK_TRACE";
    private static final String EXTRA_IMAGE_DRAWABLE_ID = "ru.gdo.android.library.crashapplication.EXTRA_IMAGE_DRAWABLE_ID";

    //General constants
    private final static String TAG = "CustomActivityOnCrash";
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "ru.gdo.android.library.crashapplication.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "ru.gdo.android.library.crashapplication.RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = "ru.gdo.android.library.crashapplication";
